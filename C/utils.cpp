...
std::string Utils::curlGetReq(CURL *curl, const std::string_view url) {
...
std::string Utils::lowerCaseString(std::string_view str) {
    std::string res;
    res.resize(str.size());
...
int Utils::numberOfMatches(std::string_view str, std::string_view pattern) {
    int n = 0;
...
std::set<std::string > Utils::filterSocials(std::vector<std::vector<std::string> > urls) {
...
std::set<std::string > Utils::filterNumbers(std::vector<std::vector<std::string> > numbers) {
...
std::set<std::string > Utils::filterEmails(std::vector<std::vector<std::string> > emails) {
...
std::set<std::string > Utils::filterStreets(std::vector<std::vector<std::string> > streets) {
